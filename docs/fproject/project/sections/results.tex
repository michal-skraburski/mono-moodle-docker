...
The Save Draft button (Figure~\ref{fig:survey_q5}) drew the highest approval rate: 20 of 22 responses (91\%) liked it outright, with one response in each of the remaining categories. This is a reassuring result for a control that was styled to be deliberately unobtrusive, as it suggests the affordance was noticed and valued regardless.

Taken together, the survey substantiates the claim that the delivered features were worth building: every feature achieved majority approval within both the student and the teacher group, and no feature was rejected by either group.
