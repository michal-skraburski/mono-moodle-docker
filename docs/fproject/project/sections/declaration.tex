...
I declare that the page count for this dissertation (including title page, declaration, abstract, acknowledgements, table of contents, list of illustrations, and references) is 50 pages. % MUST BE 50 or LESS

I understand that project markers are not obliged to read any appendices I include in this dissertation.


I confirm that I wish this to be assessed as a Type 1 2 \circled{1}  Dissertation (please circle).
...
\hline
Signature:  \textit{Michal S} &  \\ \hline
 Date:    24 July 2026 & \\ \hline
\end{tabular}
