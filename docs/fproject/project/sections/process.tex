...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figs/dependency_graph.png}
...
\begin{figure}[h]
    ...
    \fbox{\includegraphics[width=\dimexpr\linewidth-2\fboxrule\relax]{figs/authorpage_1.jpg}}
...
\begin{figure}[H]
    \centering
    \setlength{\fboxsep}{0pt}%
    \fbox{\includegraphics[height=0.72\textheight]{figs/authorpage_helpoverflow.jpg}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \fbox{\includegraphics[width=0.85\linewidth]{figs/studentanswer_1.jpg}}
    ...
    \begin{subfigure}{\linewidth}
        \centering
        \fbox{\includegraphics[width=0.70\linewidth]{figs/studentanswer_2.jpg}}
...
\begin{figure}[H]
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \fbox{\includegraphics[height=2.5cm]{figs/coderunner-save-draft.jpg}}
    ...
    \begin{subfigure}[b]{0.48\textwidth}
        \centering
        \fbox{\includegraphics[height=2.5cm]{figs/savedraft.jpg}}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{figs/docker_project.png}
