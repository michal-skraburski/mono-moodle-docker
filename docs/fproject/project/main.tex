...
% Bibliography
%--------------------------------
% Reference list set compactly (no entries removed): single-spaced, a smaller
% font, and tighter inter-entry spacing. No \clearpage before it, so the list
% flows straight on from the Conclusion rather than starting a fresh page.
\clearpage
\begingroup
\setstretch{1.0}
\small
