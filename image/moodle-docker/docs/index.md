...
- [moodle.skraburski.com/old](https://moodle.skraburski.com/old)
...
- [Server configuration](setup) - the setup behind this website is awesome, this page details everything about it
- [What to explore](explore) - guide that contains links to find every change
